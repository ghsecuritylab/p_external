...
import com.squareup.okhttp.internal.cta.CtaAdapter;
...
public final class HttpEngine {
  ...
  public void sendRequest() throws RequestException, RouteException, IOException {
    ...
    if (networkRequest != null) {
      ...
      */
      ...
      /*
       * ALPS03554992 Optimize MMS sending/receiving in low network speed environment.
      */
      CtaAdapter.updateMmsBufferSize(userRequest, getConnection());
  ...
  public void readResponse() throws IOException {
    ...
    if (!momsPermitted) {
        userResponse = CtaAdapter.getBadHttpResponse();
        return;
    }
